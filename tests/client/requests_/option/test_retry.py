...
def test_no_retry_on_success_status(mock_tools: RequestsMockTools) -> None:
    # GIVEN
...
def test_no_retry_on_bad_request(mock_tools: RequestsMockTools) -> None:
    # GIVEN
...
def test_can_retry(mock_tools: RequestsMockTools) -> None:
    # GIVEN
...
def test_can_throw_rate_limit_exceeded(mock_tools: RequestsMockTools) -> None:
    # GIVEN
