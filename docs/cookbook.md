...
`meatie.BaseClient`]({{ repo_url }}/master/tree/src/meatie/client.py) or [`meatie.BaseAsyncClient`]({{ repo_url }}/master/tree/src/meatie/aio/client.py). Meatie
provides implementations of these abstract classes for the
most popular HTTP libraries: [`meatie_httpx.Client`]({{ repo_url }}/master/tree/src/meatie_httpx/client.py), [
`meatie_requests.Client`]({{ repo_url }}/master/tree/src/meatie_requests/client.py), and [
`meatie_aiohttp.Client`]({{ repo_url }}/master/tree/src/meatie_aiohttp/client.py).
