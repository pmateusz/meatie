...
In the [final post](./shared_config.md) of the tutorial, you will learn how to avoid duplication by sharing configuration settings across multiple endpoint definitions.
