...
In the [final post](./default_settings.md) of the tutorial, you will learn how to avoid duplication by sharing configuration settings across multiple endpoint definitions.
